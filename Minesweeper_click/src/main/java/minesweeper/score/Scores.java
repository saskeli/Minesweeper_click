...
/**
 * Class represenging a set of scores for minesweeper_click.
 * Typically high scores
 * 
 * @author dongesa
 */
public class Scores {
    ...
    /**
     * Checks if the given number of actions for the given gametype
     * constitute a new record
     * 
     * @param gameType the type of game cleared
     * @param actions  the number of actions to clear
     * @return         true if the given description is better 
